if __name__ == '__main__':
    ...
    try:
        ...
        # engine_modules = ['search_engine_' + name for name in ['1', 'best']]
        ...
        for engine_module in engine_modules:
            try:
                ...
                if bench_lbls is not None and len(queries_results) > 0:
                    ...
                    # calculate recall:
                    for q_id, rel in q2n_relevant.items():
                        if engine_module == "search_engine_1":
                            recall_by_q_1.append(metrics.recall_single(q_results_labeled, rel, q_id))

                        elif engine_module == "search_engine_2":
                            recall_by_q_2.append(metrics.recall_single(q_results_labeled, rel, q_id))

                        elif engine_module == "search_engine_3":
                            recall_by_q_3.append(metrics.recall_single(q_results_labeled, rel, q_id))

                        elif engine_module == "search_engine_4":
                            recall_by_q_4.append(metrics.recall_single(q_results_labeled, rel, q_id))

                        elif engine_module == "search_engine_best":
                            recall_by_q_best.append(metrics.recall_single(q_results_labeled, rel, q_id))
                ...
                if q_results_labeled is not None:
                    ...
                    for i in range(1,36 ):
                        prec_i = metrics.precision(q_results_labeled, True, i)
                        p5_i = metrics.precision(q_results_labeled.groupby('query').head(5), True, i)
                        p10_i = metrics.precision(q_results_labeled.groupby('query').head(10), True, i)
                        p50_i = metrics.precision(q_results_labeled.groupby('query').head(50), True, i)
                        # recall_i = metrics.recall_single(q_results_labeled, q2n_relevant, i)

                        if engine_module == "search_engine_1":
                            prec_total_1.append(prec_i)
                            prec_5_1.append(p5_i)
                            prec_10_1.append(p10_i)
                            prec_50_1.append(p50_i)

                        elif engine_module == "search_engine_2":
                            prec_total_2.append(prec_i)
                            prec_5_2.append(p5_i)
                            prec_10_2.append(p10_i)
                            prec_50_2.append(p50_i)

                        elif engine_module == "search_engine_3":
                            prec_total_3.append(prec_i)
                            prec_5_3.append(p5_i)
                            prec_10_3.append(p10_i)
                            prec_50_3.append(p50_i)

                        elif engine_module == "search_engine_4":
                            prec_total_4.append(prec_i)
                            prec_5_4.append(p5_i)
                            prec_10_4.append(p10_i)
                            prec_50_4.append(p50_i)

                        elif engine_module == "search_engine_best":
                            prec_total_best.append(prec_i)
                            prec_5_best.append(p5_i)
                            prec_10_best.append(p10_i)
                            prec_50_best.append(p50_i)

                        # recall_by_q_best.append(recall_i)
                    if engine_module == "search_engine_1":
                        print("prec_total_1= ", prec_total_1)
                        print("prec_5_1= ", prec_5_1)
                        print("prec_10_1= ", prec_10_1)
                        print("prec_50_1= ", prec_50_1)
                        print("recall_by_q_1= ", recall_by_q_1)

                    elif engine_module == "search_engine_2":
                        print("prec_total_2= ", prec_total_2)
                        print("prec_5_2= ", prec_5_2)
                        print("prec_10_2= ", prec_10_2)
                        print("prec_50_2= ", prec_50_2)
                        print("recall_by_q_2= ", recall_by_q_2)

                    elif engine_module == "search_engine_3":
                        print("prec_total_3= ", prec_total_3)
                        print("prec_5_3= ", prec_5_3)
                        print("prec_10_3= ", prec_10_3)
                        print("prec_50_3= ", prec_50_3)
                        print("recall_by_q_3= ", recall_by_q_3)

                    elif engine_module == "search_engine_4":
                        print("prec_total_4= ", prec_total_4)
                        print("prec_5_4= ", prec_5_4)
                        print("prec_10_4= ", prec_10_4)
                        print("prec_50_4= ", prec_50_4)
                        print("recall_by_q_4= ", recall_by_q_4)

                    elif engine_module == "search_engine_best":
                        print("prec_total_best= ", prec_total_best)
                        print("prec_5_best= ", prec_5_best)
                        print("prec_10_best= ", prec_10_best)
                        print("prec_50_best= ", prec_50_best)
                        print("recall_by_q_best= ", recall_by_q_best)
